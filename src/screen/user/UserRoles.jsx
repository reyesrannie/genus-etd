...
import AppCardGrid from "../../components/custom/AppCardGrid";
import RoleCard from "../../components/pages/accounts/RoleCard";
...
const UserRoles = () => {
  ...
  useEffect(() => {
    if (data?.result?.data?.length) {
      setAllRoles((prevPosts) => [...prevPosts, ...data?.result?.data]);
    }
  }, [data]);
